...
export function isAdminRoute() {
  ...
  return hash.startsWith('#/admin') || hash.startsWith('#/auto-test') || hash.startsWith('#/jmeter-assistant') || hash.startsWith('#/ai-generate-cases') || hash.startsWith('#/test-coverage') || hash.startsWith('#/api-docs')
}
