...
exercises_data = [
    ...
    # ============ 测试计划的内容（15题）============
    {
        "title": '关于测试计划的\u201c测试范围\u201d（Test Scope），以下说法正确的是？',
        "description": '关于测试计划的\u201c测试范围\u201d（Test Scope），以下说法正确的是？\n\nA. 明确要测试什么、不测试什么、测试到什么程度\nB. 测试范围越大越好，覆盖所有功能\nC. 测试范围只由测试人员决定\nD. 测试范围不需要考虑项目风险',
        "solution": "A",
        "exercise_type": "single_choice",
        "difficulty": "medium",
        "category": "测试计划的内容"
    ...
    {
        "title": '请判断：测试计划中的"测试交付物"（Deliverables）包括测试报告、缺陷报告、测试数据等。',
        "description": '请判断：测试计划中的"测试交付物"（Deliverables）包括测试报告、缺陷报告、测试数据等。\n\nA. 正确\nB. 错误',
        "solution": "A",
        "exercise_type": "true_false",
        "difficulty": "medium",
        "category": "测试计划的内容"
    ...
    {
        "title": '关于测试计划的"测试进度"（Schedule），以下说法正确的是？',
        "description": '关于测试计划的"测试进度"（Schedule），以下说法正确的是？\n\nA. 应该定义测试里程碑、测试执行时间、测试报告时间\nB. 测试进度不重要，可以随意安排\nC. 测试进度只由测试人员决定，不需要考虑开发进度\nD. 测试进度应该尽可能紧凑，节省时间',
        "solution": "A",
        "exercise_type": "single_choice",
        "difficulty": "medium",
        "category": "测试计划的内容"
    ...
    {
        "title": '请判断：测试计划中的"准入/准出标准"（Entry/Exit Criteria）用于定义测试开始和结束的条件。',
        "description": '请判断：测试计划中的"准入/准出标准"（Entry/Exit Criteria）用于定义测试开始和结束的条件。\n\nA. 正确\nB. 错误',
        "solution": "A",
        "exercise_type": "true_false",
        "difficulty": "hard",
        "category": "测试计划的内容"
    ...
    {
        "title": '关于测试计划的"风险评估"（Risk Assessment），以下说法正确的是？（多选）',
        "description": '关于测试计划的"风险评估"（Risk Assessment），以下说法正确的是？（多选）\n\nA. 应该识别项目风险、技术风险、资源风险，并制定应对措施\nB. 风险评估应该定期更新，反映项目当前状态\nC. 风险评估只由测试经理负责，不需要团队参与\nD. 风险评估不重要，可以跳过',
        "solution": "A,B",
        "exercise_type": "multiple_choice",
        "difficulty": "hard",
        "category": "测试计划的内容"
    ...
    {
        "title": '请判断：测试计划中的"缺陷管理"（Defect Management）应该定义缺陷的生命周期、严重程度、优先级。',
        "description": '请判断：测试计划中的"缺陷管理"（Defect Management）应该定义缺陷的生命周期、严重程度、优先级。\n\nA. 正确\nB. 错误',
        "solution": "A",
        "exercise_type": "true_false",
        "difficulty": "medium",
        "category": "测试计划的内容"
    ...
    {
        "title": '关于测试计划的"测试培训"（Training），以下说法正确的是？（多选）',
        "description": '关于测试计划的"测试培训"（Training），以下说法正确的是？（多选）\n\nA. 如果测试团队需要特定技能，应该在测试计划中明确培训需求\nB. 测试培训应该包括工具使用、业务流程、测试技术等方面\nC. 测试培训不重要，测试人员可以自学\nD. 测试培训只针对新入职的测试人员，不包括老员工',
        "solution": "A,B",
        "exercise_type": "multiple_choice",
        "difficulty": "hard",
        "category": "测试计划的内容"
    ...
    {
        "title": '请判断：测试计划中的"配置管理"（Configuration Management）用于管理测试文档、测试脚本、测试数据的版本。',
        "description": '请判断：测试计划中的"配置管理"（Configuration Management）用于管理测试文档、测试脚本、测试数据的版本。\n\nA. 正确\nB. 错误',
        "solution": "A",
        "exercise_type": "true_false",
        "difficulty": "hard",
        "category": "测试计划的内容"
    ...
    {
        "title": '关于测试计划的"沟通计划"（Communication Plan），以下说法正确的是？',
        "description": '关于测试计划的"沟通计划"（Communication Plan），以下说法正确的是？\n\nA. 应该明确测试状态报告的频率、格式、接收人\nB. 沟通计划不重要，可以随意沟通\nC. 沟通计划只由测试经理制定，不需要考虑干系人需求\nD. 沟通计划只包括内部沟通，不包括外部沟通',
        "solution": "A",
        "exercise_type": "single_choice",
        "difficulty": "hard",
        "category": "测试计划的内容"
