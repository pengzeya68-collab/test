...
router = APIRouter(prefix="/api/v1/admin/system", tags=["Admin-系统管理"], dependencies=[Depends(require_admin)])
...
async def update_config_value(
    ...
    return {"message": "配置值已更新", "section": req.section, "key": req.key, "value": value}
