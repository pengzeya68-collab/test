...
# 路径: 测试架构设计与质量度量
# ============================================================
LESSON_CONTENT_5["测试架构设计与质量度量"] = [
    {
        "title": "第1节：测试架构师角色、能力模型与成长路径",
        "sort_order": 1,
        "knowledge_point": "测试架构师概述",
        "time_estimate": 25,
        "content": """## 测试架构师的定义与定位
