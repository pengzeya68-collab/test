...
from fastapi_backend.models.models import Base, LearningPath, LessonSection, Exercise
...
LESSON_CONTENT["软件测试基础理论"] = [
    {
        ...
        "sort_order": 1, "knowledge_point": "测试基础概念", "time_estimate": 20,
        "content": """## 软件测试的定义
...
软件测试是软件质量保障的核心活动。一个好的测试工程师不仅要有发现问题的敏锐嗅觉，还要理解测试在整个软件工程中的定位和价值。"""
    ...
    {
        "title": "第2节：测试的七大原则",
        "sort_order": 2, "knowledge_point": "测试原则", "time_estimate": 25,
...
这七大原则是每个测试工程师必须牢记的准则。"""
    },
    {
        ...
        "sort_order": 3, "knowledge_point": "开发模型", "time_estimate": 25,
        "content": """## 常见的软件开发模型
...
理解各种开发模型对测试策略的选择至关重要。"""
    ...
    {
        "title": "第4节：测试分类体系",
        "sort_order": 4, "knowledge_point": "测试分类", "time_estimate": 25,
        "content": """## 按测试阶段分类
...
- **探索性测试**：基于经验和直觉的自由测试"""
    ...
    {
        "title": "第5节：缺陷管理",
        "sort_order": 5, "knowledge_point": "缺陷管理", "time_estimate": 20,
        "content": """## 什么是软件缺陷（Bug）？
...
- **GitHub Issues**：适合小团队"""
    ...
    {
        "title": "第6节：测试用例设计基础",
        "sort_order": 6, "knowledge_point": "测试用例要素", "time_estimate": 20,
        "content": """## 什么是测试用例？
...
> 2. 右上角显示用户名"admin" """
    ...
    {
        "title": "第7节：测试级别详解",
        "sort_order": 7, "knowledge_point": "测试级别", "time_estimate": 25,
        "content": """## 测试金字塔
...
测试金字塔是指导测试策略的核心模型。投入比例应该是：单元测试 > 集成测试 > E2E测试。"""
    ...
    {
        "title": "第8节：敏捷测试与持续测试",
        "sort_order": 8, "knowledge_point": "敏捷测试", "time_estimate": 25,
        "content": """## 敏捷测试的核心概念
...
LESSON_CONTENT["SQL数据库基础"] = [
    {
        "title": "第1节：数据库基础概念",
        "sort_order": 1, "knowledge_point": "数据库概述", "time_estimate": 20,
        "content": """## 什么是数据库？
...
- **3NF**：非主键字段不依赖于其他非主键字段"""
    },
    {
        ...
        "sort_order": 2, "knowledge_point": "DDL建表", "time_estimate": 25,
        "content": """## MySQL常用数据类型
...
```"""
    },
    {
        ...
        "sort_order": 3, "knowledge_point": "SQL基础查询", "time_estimate": 25,
        "content": """## SELECT 基本语法
...
执行顺序：`SELECT → FROM → WHERE → ORDER BY → LIMIT`"""
    },
    {
        ...
        "sort_order": 4, "knowledge_point": "高级查询", "time_estimate": 30,
        "content": """## 聚合函数
...
```"""
    },
    {
        ...
        "sort_order": 5, "knowledge_point": "DML操作", "time_estimate": 20,
        "content": """## INSERT 插入数据
...
5. **避免在循环中执行SQL**"""
    ...
    {
        "title": "第6节：多表连接查询",
        "sort_order": 6, "knowledge_point": "多表连接", "time_estimate": 30,
        "content": """## 连接分类
...
```"""
    ...
    {
        "title": "第7节：子查询",
        "sort_order": 7, "knowledge_point": "子查询", "time_estimate": 25,
        "content": """## 什么是子查询？
...
4. 使用EXPLAIN查看执行计划"""
    ...
    {
        "title": "第8节：索引与事务",
        "sort_order": 8, "knowledge_point": "索引与事务", "time_estimate": 25,
        "content": """## 索引（Index）
...
LESSON_CONTENT["Linux基础命令"] = [
    {
        ...
        "sort_order": 1, "knowledge_point": "文件操作", "time_estimate": 20,
        "content": """## Linux目录结构
...
```"""
    ...
    {
        "title": "第2节：文本处理三剑客",
        "sort_order": 2, "knowledge_point": "grep/sed/awk", "time_estimate": 25,
        "content": """## grep - 文本搜索
...
```"""
    ...
    {
        "title": "第3节：进程管理与系统监控",
        "sort_order": 3, "knowledge_point": "进程管理", "time_estimate": 20,
        "content": """## 进程管理
...
```"""
    ...
    {
        "title": "第4节：Shell脚本基础",
        "sort_order": 4, "knowledge_point": "Shell脚本", "time_estimate": 25,
        "content": """## Shell脚本入门
...
```"""
    ...
    {
        "title": "第5节：日志分析与故障排查",
        "sort_order": 5, "knowledge_point": "日志分析", "time_estimate": 20,
        "content": """## 日志类型与位置
...
LESSON_CONTENT["Python编程基础"] = [
    {
        ...
        "sort_order": 1, "knowledge_point": "Python环境", "time_estimate": 20,
        "content": """## Python简介
...
```"""
    ...
    {
        "title": "第2节：变量与数据类型",
        "sort_order": 2, "knowledge_point": "变量与数据类型", "time_estimate": 25,
        "content": """## 变量
...
```"""
    ...
    {
        "title": "第3节：条件判断与循环",
        "sort_order": 3, "knowledge_point": "流程控制", "time_estimate": 25,
        "content": """## if 条件判断
...
```"""
    ...
    {
        "title": "第4节：列表与元组",
        "sort_order": 4, "knowledge_point": "列表元组", "time_estimate": 25,
        "content": """## 列表（List）
...
| 字典的键 | 元组 |"""
    ...
    {
        "title": "第5节：字典与集合",
        "sort_order": 5, "knowledge_point": "字典集合", "time_estimate": 25,
...
| set | {} | 无序 | 可变 | 不可重复 |"""
    ...
    {
        "title": "第6节：函数",
        "sort_order": 6, "knowledge_point": "函数", "time_estimate": 30,
        "content": """## 函数的定义
...
```"""
    ...
    {
        "title": "第7节：面向对象编程",
        "sort_order": 7, "knowledge_point": "面向对象", "time_estimate": 30,
        "content": """## 类与对象
...
```"""
    ...
    {
        "title": "第8节：文件操作",
        "sort_order": 8, "knowledge_point": "文件操作", "time_estimate": 20,
        "content": """## 文件操作基础
...
```"""
    ...
    {
        "title": "第9节：异常处理",
        "sort_order": 9, "knowledge_point": "异常处理", "time_estimate": 20,
        "content": """## 异常类型
...
```"""
    },
    {
        ...
        "sort_order": 10, "knowledge_point": "标准库", "time_estimate": 25,
...
LESSON_CONTENT["计算机基础与网络知识"] = [
    {
        ...
        "sort_order": 1, "knowledge_point": "HTTP协议", "time_estimate": 25,
        "content": """## HTTP请求结构
...
```"""
    },
    {
        ...
        "sort_order": 2, "knowledge_point": "TCP/IP", "time_estimate": 20,
        "content": """## TCP/IP四层模型
...
```"""
    },
    {
        ...
        "sort_order": 3, "knowledge_point": "RESTful API", "time_estimate": 20,
...
```"""
    ...
    {
        "title": "第4节：DNS与域名解析",
        "sort_order": 4, "knowledge_point": "DNS", "time_estimate": 15,
        "content": """## DNS概述
...
```"""
    },
    {
        ...
        "sort_order": 5, "knowledge_point": "WebSocket", "time_estimate": 15,
        "content": """## WebSocket概述
...
LESSON_CONTENT["测试用例设计方法"] = [
    {
        "title": "第1节：等价类划分法",
        "sort_order": 1, "knowledge_point": "等价类划分", "time_estimate": 25,
        "content": """## 等价类划分法的定义
...
| TC_006 | 1380013800A | I6 | 提示"手机号只能包含数字" |"""
    ...
    {
        "title": "第2节：边界值分析法",
        "sort_order": 2, "knowledge_point": "边界值分析", "time_estimate": 25,
        "content": """## 边界值分析法的原理
...
4. **关注输出边界**：不仅是输入有边界，输出也有（如报表最多导出多少条）"""
    ...
    {
        "title": "第3节：判定表法",
        "sort_order": 3, "knowledge_point": "判定表", "time_estimate": 25,
        "content": """## 判定表法概述
...
> n个二值条件最多产生2^n条规则。5个条件=32条，6个条件=64条。因此实际应用中需要化简。"""
    },
    {
        ...
        "sort_order": 4, "knowledge_point": "因果图与正交", "time_estimate": 25,
...
| 两两组合(Pairwise) | 多因素多水平 | 较少 | 覆盖两两组合 |"""
    },
    {
        ...
        "sort_order": 5, "knowledge_point": "场景法", "time_estimate": 25,
        "content": """## 场景法概述
...
4. **考虑数据的生命周期**：如订单从创建→支付→发货→签收→退货的完整链路"""
    },
    {
        ...
        "sort_order": 6, "knowledge_point": "错误推测", "time_estimate": 20,
...
- **快递员漫游**：跟踪数据在系统中的流转"""
    ...
    {
        "title": "第7节：白盒测试方法",
        "sort_order": 7, "knowledge_point": "白盒测试", "time_estimate": 25,
        "content": """## 白盒测试概述
...
- [ ] 是否有硬编码的密码/密钥？"""
    ...
    {
        "title": "第8节：测试用例评审与维护",
        "sort_order": 8, "knowledge_point": "用例评审", "time_estimate": 20,
        "content": """## 测试用例评审
...
LESSON_CONTENT["缺陷管理与追踪"] = [
    {
        "title": "第1节：缺陷生命周期详解",
        "sort_order": 1, "knowledge_point": "缺陷流程", "time_estimate": 20,
        "content": """## 缺陷生命周期
...
```"""
    ...
    {
        "title": "第2节：高质量缺陷报告编写",
        "sort_order": 2, "knowledge_point": "缺陷报告", "time_estimate": 25,
        "content": """## 缺陷报告的黄金法则
...
5. **不提供复现率**：开发无法判断是偶现还是必现"""
    },
    {
        ...
        "sort_order": 3, "knowledge_point": "严重度与优先级", "time_estimate": 20,
...
| Won't Fix | 评估后决定不修复（成本>收益） |"""
    },
    {
        ...
        "sort_order": 4, "knowledge_point": "缺陷工具", "time_estimate": 25,
        "content": """## JIRA核心操作
...
5. **定期回顾**：每迭代分析缺陷趋势和分布"""
    ...
    {
        "title": "第5节：缺陷统计与趋势分析",
        "sort_order": 5, "knowledge_point": "缺陷分析", "time_estimate": 20,
        "content": """## 缺陷度量指标
...
- 缺陷修复率 > 发现率"""
    },
    {
        ...
        "sort_order": 6, "knowledge_point": "根因分析", "time_estimate": 20,
...
LESSON_CONTENT["测试计划编写与项目管理"] = [
    {
        "title": "第1节：测试计划核心要素",
        "sort_order": 1, "knowledge_point": "测试计划", "time_estimate": 25,
        "content": """## 测试计划概述
...
| 未明确退出标准 | 测试无法结束 | 定义量化通过标准 |"""
    ...
    {
        "title": "第2节：测试策略制定",
        "sort_order": 2, "knowledge_point": "测试策略", "time_estimate": 25,
        "content": """## 测试策略的核心问题
...
```"""
    ...
    {
        "title": "第3节：测试工作量估算",
        "sort_order": 3, "knowledge_point": "工作量估算", "time_estimate": 20,
        "content": """## 测试工作量估算方法
...
```"""
    ...
    {
        "title": "第4节：测试风险评估与管理",
        "sort_order": 4, "knowledge_point": "风险管理", "time_estimate": 25,
        "content": """## 测试风险管理流程
...
| R2 | 性能测试工具授权过期 | 2 | 3 | 6 | 接受:用开源替代 | 李四 | 已关闭 |"""
    ...
    {
        "title": "第5节：测试进度跟踪与报告",
        "sort_order": 5, "knowledge_point": "进度报告", "time_estimate": 20,
        "content": """## 测试进度跟踪指标
...
```"""
    ...
    {
        "title": "第6节：测试团队角色与分工",
        "sort_order": 6, "knowledge_point": "团队管理", "time_estimate": 20,
        "content": """## 测试团队组织架构
    ...
    async with async_session() as session:
        ...
        for pdata in ALL_PATHS:
            existing = await session.execute(
                select(LearningPath).where(LearningPath.title == pdata["title"])
            )
        ...
        for title, lessons in LESSON_CONTENT.items():
            if title not in path_objects:
                result = await session.execute(
                    select(LearningPath).where(LearningPath.title == title)
                )
