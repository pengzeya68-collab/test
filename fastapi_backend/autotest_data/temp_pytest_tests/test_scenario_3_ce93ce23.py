...
class TestScenario3:
    ...
    def test_step_2(self):
        ...
        response_body = "{\"results\":[{\"gender\":\"female\",\"name\":{\"title\":\"Miss\",\"first\":\"Eleanor\",\"last\":\"Larson\"},\"location\":{\"street\":{\"number\":9564,\"name\":\"Westmoreland Street\"},\"city\":\"Wexford\",\"state\":\"Louth\",\"country\":\"Ireland\",\"postcode\":44282,\"coordinates\":{\"latitude\":\"4.1324\",\"longitude\":\"54.9176\"},\"timezone\":{\"offset\":\"+3:00\",\"description\":\"Baghdad, Riyadh, Moscow, St. Petersburg\"}},\"email\":\"eleanor.larson@example.com\",\"login\":{\"uuid\":\"4828fff9-65fd-4abc-8723-a0fddf4c13dd\",\"username\":\"brownostrich136\",\"password\":\"boss\",\"salt\":\"u7YNSUrE\",\"md5\":\"220ff9009042b544c2217c97a6761864\",\"sha1\":\"29ed2bdad10ff7e57742693c759b52e4dc4fb29e\",\"sha256\":\"46bc6c45e3771bf0a756eb359bb0c5b51dd18fdbadc426badc4ee4a293bf4e26\"},\"dob\":{\"date\":\"2000-11-19T06:55:09.670Z\",\"age\":25},\"registered\":{\"date\":\"2019-08-14T23:35:14.395Z\",\"age\":6},\"phone\":\"071-271-2882\",\"cell\":\"081-106-2471\",\"id\":{\"name\":\"PPS\",\"value\":\"4367596T\"},\"picture\":{\"large\":\"https://randomuser.me/api/portraits/women/81.jpg\",\"medium\":\"https://randomuser.me/api/portraits/med/women/81.jpg\",\"thumbnail\":\"https://randomuser.me/api/portraits/thumb/women/81.jpg\"},\"nat\":\"IE\"}],\"info\":{\"seed\":\"08f214c797cdd992\",\"results\":1,\"page\":1,\"version\":\"1.4\"}}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
    ...
    def test_step_9(self):
        ...
        response_body = "{\n  \"content\" : \"七夕年年信不违，银河清浅白云微，蟾光鹊影伯劳飞。\",\n  \"origin\" : \"浣溪沙·七夕年年信不违\",\n  \"author\" : \"毛文锡\",\n  \"category\" : \"古诗文-节日-七夕节\"\n}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
