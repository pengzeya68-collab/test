...
class TestScenario3:
    ...
    def test_step_2(self):
        ...
        response_body = "{\"results\":[{\"gender\":\"male\",\"name\":{\"title\":\"Mr\",\"first\":\"Hans-Erich\",\"last\":\"Hellmann\"},\"location\":{\"street\":{\"number\":8990,\"name\":\"Im Winkel\"},\"city\":\"Spangenberg\",\"state\":\"Niedersachsen\",\"country\":\"Germany\",\"postcode\":20775,\"coordinates\":{\"latitude\":\"-50.0353\",\"longitude\":\"-101.2453\"},\"timezone\":{\"offset\":\"-12:00\",\"description\":\"Eniwetok, Kwajalein\"}},\"email\":\"hans-erich.hellmann@example.com\",\"login\":{\"uuid\":\"550e6d81-4e29-46ce-8551-772602fcd960\",\"username\":\"greenbutterfly497\",\"password\":\"fudge\",\"salt\":\"p6iKxV5a\",\"md5\":\"7e1cc171d867bb629499bef8cd429618\",\"sha1\":\"5a17af4d7c27d547f513dba503b5f1e2352ec6e8\",\"sha256\":\"3278af6c1b7df629799b7a06ab41c41f37f8a219a0e82c129ed7759ec7562d1f\"},\"dob\":{\"date\":\"1971-07-01T13:33:25.194Z\",\"age\":54},\"registered\":{\"date\":\"2005-06-03T01:21:16.733Z\",\"age\":20},\"phone\":\"0019-7854020\",\"cell\":\"0176-6818822\",\"id\":{\"name\":\"SVNR\",\"value\":\"49 010771 H 028\"},\"picture\":{\"large\":\"https://randomuser.me/api/portraits/men/40.jpg\",\"medium\":\"https://randomuser.me/api/portraits/med/men/40.jpg\",\"thumbnail\":\"https://randomuser.me/api/portraits/thumb/men/40.jpg\"},\"nat\":\"DE\"}],\"info\":{\"seed\":\"66df3897e209a462\",\"results\":1,\"page\":1,\"version\":\"1.4\"}}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
    ...
    def test_step_3(self):
        """[PUT] 根据 ID 修改该用户信息"""
        with allure.step("1. 发起HTTP请求: PUT https://httpbin.org/put"):
            request_info = {
        ...
        response_body = "{\n  \"args\": {}, \n  \"data\": \"{\\\"id\\\":\\\"{{new_user_id}}\\\",\\\"name\\\":\\\"TestMaster \\u8d85\\u7ea7\\u725b\\u903c\\\"}\", \n  \"files\": {}, \n  \"form\": {}, \n  \"headers\": {\n    \"Accept\": \"*/*\", \n    \"Accept-Encoding\": \"gzip, deflate\", \n    \"Content-Length\": \"57\", \n    \"Content-Type\": \"application/json\", \n    \"Host\": \"httpbin.org\", \n    \"User-Agent\": \"python-httpx/0.28.1\", \n    \"X-Amzn-Trace-Id\": \"Root=1-6a14a4e5-65d0d0ac2a68c58f24e62377\"\n  }, \n  \"json\": {\n    \"id\": \"{{new_user_id}}\", \n    \"name\": \"TestMaster \\u8d85\\u7ea7\\u725b\\u903c\"\n  }, \n  \"origin\": \"34.81.200.93\", \n  \"url\": \"https://httpbin.org/put\"\n}\n"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
    ...
    def test_step_6(self):
        """[GET] GET bearer"""
        with allure.step("1. 发起HTTP请求: GET https://httpbin.org/bearer"):
            request_info = {
