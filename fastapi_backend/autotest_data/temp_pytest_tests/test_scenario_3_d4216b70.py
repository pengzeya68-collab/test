...
class TestScenario3:
    ...
    def test_step_2(self):
        ...
        response_body = "{\"results\":[{\"gender\":\"male\",\"name\":{\"title\":\"Mr\",\"first\":\"Philip\",\"last\":\"Christensen\"},\"location\":{\"street\":{\"number\":1235,\"name\":\"Overgade\"},\"city\":\"Lemvig\",\"state\":\"Midtjylland\",\"country\":\"Denmark\",\"postcode\":94949,\"coordinates\":{\"latitude\":\"-43.1468\",\"longitude\":\"-47.1596\"},\"timezone\":{\"offset\":\"+3:00\",\"description\":\"Baghdad, Riyadh, Moscow, St. Petersburg\"}},\"email\":\"philip.christensen@example.com\",\"login\":{\"uuid\":\"c081975f-0641-4f8b-b89c-fbc44874183d\",\"username\":\"orangerabbit985\",\"password\":\"killme\",\"salt\":\"czqh8HRm\",\"md5\":\"7fa244f509bbf36c52f85e9e60b6c011\",\"sha1\":\"abb06f3a6194d8792b21f27ea147fe2df5d7a2f8\",\"sha256\":\"4a8a850278671de3dbb1e5e49b09e94a8a1f06bc37ce25f8b8c3b8458c354d27\"},\"dob\":{\"date\":\"1986-11-22T08:48:56.084Z\",\"age\":39},\"registered\":{\"date\":\"2018-06-15T09:59:04.210Z\",\"age\":7},\"phone\":\"25420518\",\"cell\":\"74761135\",\"id\":{\"name\":\"CPR\",\"value\":\"221186-9286\"},\"picture\":{\"large\":\"https://randomuser.me/api/portraits/men/27.jpg\",\"medium\":\"https://randomuser.me/api/portraits/med/men/27.jpg\",\"thumbnail\":\"https://randomuser.me/api/portraits/thumb/men/27.jpg\"},\"nat\":\"DK\"}],\"info\":{\"seed\":\"5f5522b717fdbbed\",\"results\":1,\"page\":1,\"version\":\"1.4\"}}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
    ...
    def test_step_8(self):
        ...
        status_code = 200
        response_time_ms = 965
        response_body = "{\n  \"args\": {}, \n  \"headers\": {\n    \"Accept\": \"*/*\", \n    \"Accept-Encoding\": \"gzip, deflate\", \n    \"Host\": \"httpbin.org\", \n    \"User-Agent\": \"TestMaster-Pro-Client\", \n    \"X-Amzn-Trace-Id\": \"Root=1-69de9184-703060f43a0804bc704e00b1\", \n    \"X-Custom-Header\": \"MySecretValue123\"\n  }, \n  \"origin\": \"34.80.75.224\", \n  \"url\": \"https://httpbin.org/get\"\n}\n"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
    ...
    def test_step_9(self):
        ...
        status_code = 200
        response_time_ms = 95
        response_body = "{\n  \"content\" : \"昨梦西湖，老扁舟身世。\",\n  \"origin\" : \"拜星月慢·林钟羽姜石帚以盆莲数十置中庭宴客其中\",\n  \"author\" : \"吴文英\",\n  \"category\" : \"古诗文-山水-西湖\"\n}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
