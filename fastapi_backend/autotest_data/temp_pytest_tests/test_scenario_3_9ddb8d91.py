...
class TestScenario3:
    ...
    def test_step_2(self):
        ...
        response_body = "{\"results\":[{\"gender\":\"male\",\"name\":{\"title\":\"Mr\",\"first\":\"Iván\",\"last\":\"Miranda\"},\"location\":{\"street\":{\"number\":6933,\"name\":\"Calle Tonga\"},\"city\":\"Santa Ana Jilotzingo\",\"state\":\"Yucatan\",\"country\":\"Mexico\",\"postcode\":25247,\"coordinates\":{\"latitude\":\"26.1458\",\"longitude\":\"-140.9356\"},\"timezone\":{\"offset\":\"-6:00\",\"description\":\"Central Time (US & Canada), Mexico City\"}},\"email\":\"ivan.miranda@example.com\",\"login\":{\"uuid\":\"793b3cf2-73fa-4c3b-86d5-5e79a5dea64f\",\"username\":\"ticklishgoose427\",\"password\":\"goodboy\",\"salt\":\"Bl8OUmUp\",\"md5\":\"436ce7e906fe0159238128eb29e6262c\",\"sha1\":\"eeb8d6b91edb5cc4784112644987a309713fda1b\",\"sha256\":\"3803d5e994cdfae6396e06747277566c454d7447200cd739294c98a522cd1f95\"},\"dob\":{\"date\":\"1994-09-26T04:14:23.664Z\",\"age\":31},\"registered\":{\"date\":\"2011-03-30T00:59:35.806Z\",\"age\":15},\"phone\":\"(663) 896 4394\",\"cell\":\"(687) 575 2234\",\"id\":{\"name\":\"NSS\",\"value\":\"36 41 36 5707 2\"},\"picture\":{\"large\":\"https://randomuser.me/api/portraits/men/59.jpg\",\"medium\":\"https://randomuser.me/api/portraits/med/men/59.jpg\",\"thumbnail\":\"https://randomuser.me/api/portraits/thumb/men/59.jpg\"},\"nat\":\"MX\"}],\"info\":{\"seed\":\"2b73420bf3295cf6\",\"results\":1,\"page\":1,\"version\":\"1.4\"}}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
    ...
    def test_step_8(self):
        ...
        status_code = 200
        response_time_ms = 931
        response_body = "{\n  \"args\": {}, \n  \"headers\": {\n    \"Accept\": \"*/*\", \n    \"Accept-Encoding\": \"gzip, deflate\", \n    \"Host\": \"httpbin.org\", \n    \"User-Agent\": \"TestMaster-Pro-Client\", \n    \"X-Amzn-Trace-Id\": \"Root=1-69de8ab9-6ae84c7e27d1f4f74c8356d8\", \n    \"X-Custom-Header\": \"MySecretValue123\"\n  }, \n  \"origin\": \"34.80.75.224\", \n  \"url\": \"https://httpbin.org/get\"\n}\n"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
