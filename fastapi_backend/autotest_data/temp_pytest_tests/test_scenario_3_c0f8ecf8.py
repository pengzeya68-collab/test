...
class TestScenario3:
    ...
    def test_step_2(self):
        ...
        response_body = "{\"results\":[{\"gender\":\"male\",\"name\":{\"title\":\"Mr\",\"first\":\"Frank\",\"last\":\"Stewart\"},\"location\":{\"street\":{\"number\":387,\"name\":\"Walnut Hill Ln\"},\"city\":\"Chesapeake\",\"state\":\"Maine\",\"country\":\"United States\",\"postcode\":98583,\"coordinates\":{\"latitude\":\"85.0023\",\"longitude\":\"-91.4061\"},\"timezone\":{\"offset\":\"+5:30\",\"description\":\"Bombay, Calcutta, Madras, New Delhi\"}},\"email\":\"frank.stewart@example.com\",\"login\":{\"uuid\":\"5db0f25f-a9cb-41e3-89de-11d672c7c9de\",\"username\":\"ticklishtiger203\",\"password\":\"messiah\",\"salt\":\"NLWSf5or\",\"md5\":\"9f639d169257143f691e831da109587b\",\"sha1\":\"b9cddf218a117d893874efaf248258d33c10faa8\",\"sha256\":\"8ee8b1df6a462cfeefc742d10259825a011cd509dfb9c489f4f72401f13a14fb\"},\"dob\":{\"date\":\"1950-07-16T06:07:56.053Z\",\"age\":75},\"registered\":{\"date\":\"2019-11-01T22:42:30.003Z\",\"age\":6},\"phone\":\"(517) 576-8825\",\"cell\":\"(660) 355-6354\",\"id\":{\"name\":\"SSN\",\"value\":\"806-41-1225\"},\"picture\":{\"large\":\"https://randomuser.me/api/portraits/men/38.jpg\",\"medium\":\"https://randomuser.me/api/portraits/med/men/38.jpg\",\"thumbnail\":\"https://randomuser.me/api/portraits/thumb/men/38.jpg\"},\"nat\":\"US\"}],\"info\":{\"seed\":\"78d4fbbc9d63e45b\",\"results\":1,\"page\":1,\"version\":\"1.4\"}}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
    ...
    def test_step_9(self):
        ...
        response_body = "{\n  \"content\" : \"残霞夕照西湖好，花坞苹汀，十顷波平，野岸无人舟自横。\",\n  \"origin\" : \"采桑子·残霞夕照西湖好\",\n  \"author\" : \"欧阳修\",\n  \"category\" : \"古诗文-山水-西湖\"\n}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
