...
class TestScenario3:
    ...
    def test_step_2(self):
        ...
        response_body = "{\"results\":[{\"gender\":\"male\",\"name\":{\"title\":\"Mr\",\"first\":\"Rodney\",\"last\":\"Harrison\"},\"location\":{\"street\":{\"number\":7387,\"name\":\"Country Club Rd\"},\"city\":\"Murrieta\",\"state\":\"Michigan\",\"country\":\"United States\",\"postcode\":54341,\"coordinates\":{\"latitude\":\"84.9170\",\"longitude\":\"-137.4165\"},\"timezone\":{\"offset\":\"+9:30\",\"description\":\"Adelaide, Darwin\"}},\"email\":\"rodney.harrison@example.com\",\"login\":{\"uuid\":\"d5eb1967-2763-4bd7-8c87-3ab5d78375d2\",\"username\":\"orangeladybug292\",\"password\":\"roberta\",\"salt\":\"iCzlSZEc\",\"md5\":\"5a40bb3f0c8b1c4b950a621298bfdc05\",\"sha1\":\"ccb526a7d9d9b92c88c9155bed183b01550b0894\",\"sha256\":\"6def007cb2d3b23617f6515cfa0f5424912583a6b423d00d8450e920624c0acc\"},\"dob\":{\"date\":\"1982-11-10T11:27:01.735Z\",\"age\":43},\"registered\":{\"date\":\"2016-08-20T17:45:29.448Z\",\"age\":9},\"phone\":\"(845) 343-8139\",\"cell\":\"(544) 962-9911\",\"id\":{\"name\":\"SSN\",\"value\":\"661-90-9288\"},\"picture\":{\"large\":\"https://randomuser.me/api/portraits/men/32.jpg\",\"medium\":\"https://randomuser.me/api/portraits/med/men/32.jpg\",\"thumbnail\":\"https://randomuser.me/api/portraits/thumb/men/32.jpg\"},\"nat\":\"US\"}],\"info\":{\"seed\":\"e200b3294e166267\",\"results\":1,\"page\":1,\"version\":\"1.4\"}}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
    ...
    def test_step_9(self):
        ...
        response_body = "{\n  \"content\" : \"毕竟年年用着来，何似休归去。\",\n  \"origin\" : \"楚天遥过清江引·有意送春归\",\n  \"author\" : \"如晦\",\n  \"category\" : \"古诗文-抒情-离别\"\n}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
