...
class TestScenario3:
    ...
    def test_step_2(self):
        ...
        response_body = "{\"results\":[{\"gender\":\"male\",\"name\":{\"title\":\"Mr\",\"first\":\"Martin\",\"last\":\"Hansen\"},\"location\":{\"street\":{\"number\":7571,\"name\":\"Westheimer Rd\"},\"city\":\"Akron\",\"state\":\"North Dakota\",\"country\":\"United States\",\"postcode\":87469,\"coordinates\":{\"latitude\":\"87.9904\",\"longitude\":\"-116.9281\"},\"timezone\":{\"offset\":\"-10:00\",\"description\":\"Hawaii\"}},\"email\":\"martin.hansen@example.com\",\"login\":{\"uuid\":\"a51cf0ad-69a9-43e9-a8bc-f58909418594\",\"username\":\"sadrabbit972\",\"password\":\"leslie\",\"salt\":\"yJPJp4K4\",\"md5\":\"627feeb3f74b56830385bd25a0b51fae\",\"sha1\":\"f3ec3ddc9ba53d34ea13f3e5662b6f9b5726d182\",\"sha256\":\"07524c6c9ce4a3edda2182a93e33bb2268355fb1cbc41919d6f40b50a59e0731\"},\"dob\":{\"date\":\"1964-07-15T19:30:44.847Z\",\"age\":61},\"registered\":{\"date\":\"2012-05-15T08:55:01.110Z\",\"age\":13},\"phone\":\"(262) 253-5219\",\"cell\":\"(304) 221-2785\",\"id\":{\"name\":\"SSN\",\"value\":\"575-21-7024\"},\"picture\":{\"large\":\"https://randomuser.me/api/portraits/men/57.jpg\",\"medium\":\"https://randomuser.me/api/portraits/med/men/57.jpg\",\"thumbnail\":\"https://randomuser.me/api/portraits/thumb/men/57.jpg\"},\"nat\":\"US\"}],\"info\":{\"seed\":\"719ce4641dbb4bf9\",\"results\":1,\"page\":1,\"version\":\"1.4\"}}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
    ...
    def test_step_8(self):
        ...
        with allure.step("3. 执行断言校验"):
        assert False, "步骤8失败: 断言失败: 默认断言失败: 期望 2xx/3xx (< 400), 实际返回 502"
