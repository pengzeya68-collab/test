...
class TestScenario3:
    ...
    def test_step_2(self):
        ...
        status_code = 200
        response_time_ms = 577
        response_body = "{\"results\":[{\"gender\":\"male\",\"name\":{\"title\":\"Mr\",\"first\":\"Harold\",\"last\":\"Henderson\"},\"location\":{\"street\":{\"number\":1982,\"name\":\"North Street\"},\"city\":\"Sunderland\",\"state\":\"Derbyshire\",\"country\":\"United Kingdom\",\"postcode\":\"W22 6RU\",\"coordinates\":{\"latitude\":\"-8.2994\",\"longitude\":\"-148.4975\"},\"timezone\":{\"offset\":\"0:00\",\"description\":\"Western Europe Time, London, Lisbon, Casablanca\"}},\"email\":\"harold.henderson@example.com\",\"login\":{\"uuid\":\"66738d47-38a6-4178-8990-21b4ed43f819\",\"username\":\"organicbird215\",\"password\":\"mizuno\",\"salt\":\"lIPAfDGX\",\"md5\":\"64434e5d2f9382bb526caf32d6cf32d9\",\"sha1\":\"0aca07932820b806467aceb533ab1309342339db\",\"sha256\":\"dcf9de27846d3c0017d63929d6c368ba4aebf93df2c5cf76786cec81c6de50a5\"},\"dob\":{\"date\":\"1949-11-13T07:49:45.445Z\",\"age\":76},\"registered\":{\"date\":\"2016-05-15T11:54:16.055Z\",\"age\":9},\"phone\":\"016977 3539\",\"cell\":\"07449 831564\",\"id\":{\"name\":\"NINO\",\"value\":\"YM 99 06 33 A\"},\"picture\":{\"large\":\"https://randomuser.me/api/portraits/men/28.jpg\",\"medium\":\"https://randomuser.me/api/portraits/med/men/28.jpg\",\"thumbnail\":\"https://randomuser.me/api/portraits/thumb/men/28.jpg\"},\"nat\":\"GB\"}],\"info\":{\"seed\":\"4fe1f7e8a85ccb1b\",\"results\":1,\"page\":1,\"version\":\"1.4\"}}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
    ...
    def test_step_9(self):
        ...
        response_body = "{\n  \"content\" : \"细雨梦回鸡塞远，小楼吹彻玉笙寒。\",\n  \"origin\" : \"摊破浣溪沙·菡萏香销翠叶残\",\n  \"author\" : \"李璟\",\n  \"category\" : \"古诗文-抒情-闺怨\"\n}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
