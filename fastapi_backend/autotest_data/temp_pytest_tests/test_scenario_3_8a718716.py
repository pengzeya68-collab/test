...
class TestScenario3:
    ...
    def test_step_2(self):
        ...
        response_body = "{\"results\":[{\"gender\":\"male\",\"name\":{\"title\":\"Mr\",\"first\":\"Shayan\",\"last\":\"Bjordal\"},\"location\":{\"street\":{\"number\":2456,\"name\":\"Tomm Murstadbakken\"},\"city\":\"Hammarvika\",\"state\":\"Vest-Agder\",\"country\":\"Norway\",\"postcode\":\"1372\",\"coordinates\":{\"latitude\":\"44.6976\",\"longitude\":\"-101.6553\"},\"timezone\":{\"offset\":\"+6:00\",\"description\":\"Almaty, Dhaka, Colombo\"}},\"email\":\"shayan.bjordal@example.com\",\"login\":{\"uuid\":\"c1c3e3e8-e4bc-4583-be95-ad21099df9d2\",\"username\":\"organicgoose711\",\"password\":\"tights\",\"salt\":\"6sQXuFnn\",\"md5\":\"a5630b02267eae5d9a906c7c543855d7\",\"sha1\":\"ca783e8ae251d0cfed105d74b0e4b6ecd1c8ce72\",\"sha256\":\"8cbc68ccac542c0aee88e2e1ae0497995a7ff07e5a25715d76d30b530f5bbfb6\"},\"dob\":{\"date\":\"1994-01-02T01:47:58.933Z\",\"age\":32},\"registered\":{\"date\":\"2005-12-17T22:08:59.434Z\",\"age\":20},\"phone\":\"25589681\",\"cell\":\"96593568\",\"id\":{\"name\":\"FN\",\"value\":\"02019425765\"},\"picture\":{\"large\":\"https://randomuser.me/api/portraits/men/8.jpg\",\"medium\":\"https://randomuser.me/api/portraits/med/men/8.jpg\",\"thumbnail\":\"https://randomuser.me/api/portraits/thumb/men/8.jpg\"},\"nat\":\"NO\"}],\"info\":{\"seed\":\"a33e8bb4ffb8b041\",\"results\":1,\"page\":1,\"version\":\"1.4\"}}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
    ...
    def test_step_9(self):
        ...
        response_body = "{\n  \"content\" : \"是天外空汗漫，但长风、浩浩送中秋。\",\n  \"origin\" : \"木兰花慢·中秋饮酒将旦客谓前人诗词有赋待月无送月者因用天问体赋\",\n  \"author\" : \"辛弃疾\",\n  \"category\" : \"古诗文-节日-中秋节\"\n}"
        with allure.step("2. 获取响应信息"):
            response_info = {
                "status_code": status_code,
                "response_time_ms": response_time_ms,
